...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub ActionButtonVisible(Assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Sub AdjustButtonsForOS()
		  #if TargetWindows then
		    OkButton.Left = me.Width - OkButton.Width - 132
		    CancelButton.Left = me.Width - CancelButton.Width - 20
		  #elseif targetmacos then
		    OkButton.Left = me.Width - OkButton.Width - 20
		    CancelButton.Left = me.Width - CancelButton.Width - 132
		  #endif
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub CancelButtonEnabled(Assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Sub CancelButtonVisible(Assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Sub SwitchButtons()
		  if OkButton.Visible and CancelButton.Visible then
		    AdjustButtonsForOS
		  elseif OkButton.Visible then
		    OkButton.Left = me.Width - OkButton.Width - 20
		  elseif CancelButton.Visible then
		    CancelButton.Left = me.Width - CancelButton.Width - 20
		  else
